...
% Edited 8/19/2014 by Megan Peters http://sites.google.com/site/meganakpeters
% Add correlation between Mratio for two tasks.
% This changes the input s.t. nR_S1{1} and nR_S2{1} now have 2 rows each,
% one for each task.  So toy data now reads as below:

% toy data
% nR_S1{1} = [1552  933  954  720  448  220   78   27;... % for first task
%             1209  980  868  750  500  301   40   9];    % for second task    
% nR_S2{1} = [33   77  213  469  729 1013  975   1559;...   % for first task
%             11   45  299  497  760  890   976  1200];    % for second task   
%           
